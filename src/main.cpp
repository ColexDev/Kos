...
int main()
{
    ...
    std::vector<std::string> entries = {"Test Entry", "Test Entry 2", "Test Entry 3", "This is a long test entry", "Test 5", "Test Entry 6", "Test Entry 7", "Test Entry 8", "Test 9", "Test 10", "Test 11", "Test 12", "Test 13", "ok"};
